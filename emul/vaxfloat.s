...
movb $typ_h,op_types(fp)
 ...
 #
 inst_cvtbf:				# entrance
movw $(typ_b+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtbx
 ...
 #
 inst_cvtbd:				# entrance
movw $(typ_b+(typ_d<<8)),op_types(fp)
 	brb	inst_cvtbx
 ...
 #
 inst_cvtbg:				# entrance
movw $(typ_b+(typ_g<<8)),op_types(fp)
 	brb	inst_cvtbx
 ...
 #
 inst_cvtbh:				# entrance
movw $(typ_b+(typ_h<<8)),op_types(fp)
 	brb	inst_cvtbx
 ...
 #
 inst_cvtwf:
movw $(typ_w+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtwx
 ...
 #
 inst_cvtwd:
movw $(typ_w+(typ_d<<8)),op_types(fp)
 	brb	inst_cvtwx
 ...
 #
 inst_cvtwg:				# entrance
movw $(typ_w+(typ_g<<8)),op_types(fp)
 	brb	inst_cvtwx
 ...
 #
 inst_cvtwh:				# entrance
movw $(typ_w+(typ_h<<8)),op_types(fp)
 	brb	inst_cvtwx
 ...
 #
 inst_cvtlf:				# entrance
movw $(typ_l+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtlx
 ...
 #
 inst_cvtld:				# entrance
movw $(typ_l+(typ_d<<8)),op_types(fp)
 	brb	inst_cvtlx
 ...
 #
 inst_cvtlg:				# entrance
movw $(typ_l+(typ_g<<8)),op_types(fp)
 	brb	inst_cvtlx
 ...
 #
 inst_cvtlh:				# entrance
movw $(typ_l+(typ_h<<8)),op_types(fp)
 #brb	inst_cvtlx
 ...
 #
 inst_cvtfb:
movw $(typ_f+(typ_b<<8)),op_types(fp)
 	brb	inst_cvtxb
 ...
 #
 inst_cvtdb:
movw $(typ_d+(typ_b<<8)),op_types(fp)
 	brb	inst_cvtxb
 ...
 #
 inst_cvtgb:
movw $(typ_g+(typ_b<<8)),op_types(fp)
 	brb	inst_cvtxb
 ...
 #
 inst_cvthb:
movw $(typ_h+(typ_b<<8)),op_types(fp)
 	brb	inst_cvtxb
 ...
 #
 inst_cvtfw:
movw $(typ_f+(typ_w<<8)),op_types(fp)
 	brb	inst_cvtxw
 ...
 #
 inst_cvtdw:
movw $(typ_d+(typ_w<<8)),op_types(fp)
 	brb	inst_cvtxw
 ...
 inst_cvtgw:
movw $(typ_g+(typ_w<<8)),op_types(fp)
 	brb	inst_cvtxw
 ...
 #
 inst_cvthw:
movw $(typ_h+(typ_w<<8)),op_types(fp)
 	brb	inst_cvtxw
 ...
 #
 inst_cvtfl:
movw $(typ_f+(typ_l<<8)),op_types(fp)
 	brb	inst_cvtxl
 ...
 #
 inst_cvtdl:
movw $(typ_d+(typ_l<<8)),op_types(fp)
 	brb	inst_cvtxl
 ...
 #
 inst_cvtgl:
movw $(typ_g+(typ_l<<8)),op_types(fp)
 	brb	inst_cvtxl
 ...
 #
 inst_cvthl:
movw $(typ_h+(typ_l<<8)),op_types(fp)
 	brb	inst_cvtxl
 ...
 #
 inst_cvtfd:
movw $(typ_f+(typ_d<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtfg:				# entrance
movw $(typ_f+(typ_g<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtfh:				# entrance
movw $(typ_f+(typ_h<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtdf:				# entrance
movw $(typ_d+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtdh:
movw $(typ_d+(typ_h<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtgf:
movw $(typ_g+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvtgh:
movw $(typ_g+(typ_h<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 inst_cvthf:
movw $(typ_h+(typ_f<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvthd:
movw $(typ_h+(typ_d<<8)),op_types(fp)
 	brb	inst_cvtxy
 ...
 #
 inst_cvthg:
movw $(typ_h+(typ_g<<8)),op_types(fp)
 #brb	inst_cvtxy
...
movb $typ_h,op_types(fp)
 ...
 #
 inst_emodf:
movb $(typ_f),op_types4(fp)
movl $(typ_f+(typ_b<<8)+(typ_f<<16)+(typ_l<<24)),op_types(fp)
 	bsbw	read_access		# first operand is read only
 ...
 #
 inst_emodd:
movb $(typ_d),op_types4(fp)
movl $(typ_d+(typ_b<<8)+(typ_d<<16)+(typ_l<<24)),op_types(fp)
 	bsbw	read_access		# first operand is read only
 	bsbw	unpack_float2		# unpack and save the operand
 	incl	op_index(fp)		# move to second operand
 	bsbw	read_access		# second operand is read only
 ...
 #
 inst_emodg:				# entrance
movb $(typ_g),op_types4(fp)
movl $(typ_g+(typ_w<<8)+(typ_g<<16)+(typ_l<<24)),op_types(fp)
 	bsbw	read_access		# first operand is read only
 	bsbw	unpack_float2		# unpack and save the operand
 	incl	op_index(fp)		# move to second operand
 	bsbw	read_access		# second operand is read only
 ...
 #
 inst_emodh:				# entrance
movb $(typ_h),op_types4(fp)
movl $(typ_h+(typ_w<<8)+(typ_h<<16)+(typ_l<<24)),op_types(fp)
 	bsbw	read_access		# first operand is read only
 	bsbw	unpack_float2		# unpack and save the operand
 	incl	op_index(fp)		# move to second operand
 	bsbw	read_access		# second operand is read only
...
movb $typ_h,op_types(fp)
 ...
 #
 inst_movao:				# entrance
movw $(typ_o+(typ_l<<8)),op_types(fp)
...
movb $typ_h,op_types(fp)
 ...
 #
 inst_polyf:				# entrance
movl $(typ_f+(typ_w<<8)+(typ_b<<16)+(typ_f<<24)),op_types(fp)
 ...
 #
 inst_polyd:				# entrance
movl $(typ_d+(typ_w<<8)+(typ_b<<16)+(typ_d<<24)),op_types(fp)
 	brw	inst_polydg
 ...
 #
 inst_polyg:				# entrance
movl $(typ_g+(typ_w<<8)+(typ_b<<16)+(typ_g<<24)),op_types(fp)
 #brb	inst_polydg
 ...
 #
 inst_polyh:				# entrance
movl $(typ_h+(typ_w<<8)+(typ_b<<16)+(typ_h<<24)),op_types(fp)
