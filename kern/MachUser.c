...
void InitMach (RPort) Port RPort;
 { 
if (RPort == NullPort)
 { 
...
#else FastAssign
	MyMsgPtr->IPCNam5 =        0;
	MyMsgPtr->IPCNam5 |= _InLine(  TRUE);
	MyMsgPtr->IPCNam5 |= _Deallocate( FALSE);
	MyMsgPtr->IPCNam5 |= _LongForm( FALSE);
...
#else FastAssign
	MyMsgPtr->IPCNam6 =        0;
	MyMsgPtr->IPCNam6 |= _InLine(  TRUE);
	MyMsgPtr->IPCNam6 |= _Deallocate( FALSE);
	MyMsgPtr->IPCNam6 |= _LongForm( FALSE);
...
#else FastAssign
	MyMsgPtr->IPCNam7 =        0;
	MyMsgPtr->IPCNam7 |= _InLine(  TRUE);
	MyMsgPtr->IPCNam7 |= _Deallocate( FALSE);
	MyMsgPtr->IPCNam7 |= _LongForm( FALSE);
...
#else FastAssign
	MyMsgPtr->IPCNam3 =        0;
	MyMsgPtr->IPCNam3 |= _InLine( FALSE);
	MyMsgPtr->IPCNam3 |= _Deallocate( FALSE);
	MyMsgPtr->IPCNam3 |= _LongForm(  TRUE);
#endif FastAssign
